...
internal static class PlacesFetcher
{
    ...
    /// <item>Convert BSON documents to proper places, add category identifier.</item>
    /// <item>Merge the list of places with the result in case the same place is associated with more than one category.</item>
    /// </list>
    /// </summary>
